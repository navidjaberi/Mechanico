<template>
  <div class="flex items-end justify-center h-1/5  mt-20">
  ...
  <v-row class="h-3/5 d-flex mt-5 justify-center" no-gutters>
    <v-col cols="12" sm="6" class="pa-7">
